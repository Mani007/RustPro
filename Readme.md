...
#### Use memory-view map extension to view memory map with address of your program. Tools are also known as memory profile tools such as vmmaps etc. MS Visual studio has best debugger tools with memory profiler for c++ programs.  
