...
fn main() {
    ...
    println!("The value of multiple read operation is {} and {} ", read1, read2); // The moment we call both refernce of s1, although we are just reading, the error will occour
}
